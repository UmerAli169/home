    ...
    <section className='flex flex-col items-center  py-[120px] '>
      <Wrapper>
        <div className='flex flex-col items-center    '>
          ...
          <div className='flex flex-col sm:flex-row sm:flex-wrap sm:justify-center gap-[30px] w-full  lg:px-[125px] lg:pt-[120px] px-[16px] pt-[32px]'>
            {features.map((feature, index) => (
              <FeatureCard
                key={index}
                {...feature}
                className=' gap-20 w-full sm:max-w-[256px]  shadow-lg'
              />
            ))}
          </div>
        </div>
