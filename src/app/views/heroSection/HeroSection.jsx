...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const autoScroll = () => {
      ...
      slider.scrollLeft += direction * 2;
    };

    scrollInterval.current = setInterval(autoScroll, 50);
    ...
    <section className='  relative max-h-[791px] h-full flex flex-col   text-center pb-[80px] bg-[#FFF7F7] overflow-hidden font-lora'>
      <div className='flex flex-col items-center justify-center text-center  ]  '>
        <div className='container relative pt-[48px] lg:pt-[80px]'>
          ...
          />
          <div className='pb-[48px] relative flex flex-col items-center justify-center text-center  max-w-[880px] mx-auto '>
