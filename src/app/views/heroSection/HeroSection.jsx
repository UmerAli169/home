    ...
    <section className=" relative max-h-[791px] h-full flex flex-col   text-center py-[38px] bg-[#FFF7F7] overflow-hidden font-lora">
      <div>
        <img
          ...
          alt="Girl"
          className="xl:ml-[20%] lg:ml-[18%] md:ml-[15%] sm:ml-[12%] ml-[5%]"
        />
        <img
          src="/svg/herosection/star2.svg"
          alt="Star"
          className=" xl:ml-[20%] lg:ml-[18%] md:ml-[15%] sm:ml-[12%] ml-[5%] top-[200px] left-[630px] w-[40px] h-[40px]"
        />
        <img
          src="/svg/herosection/star.svg"
          alt="Star"
          className="xl:right-[320px]  top-[160px] right-[30px]  sm:right-[10px] absolute md:right-[50px] lg:right-[150px] w-[40px] h-[40px]"
        />
        <img
      ...
      <div className="flex flex-col items-center justify-center text-center  ] overflow-hidden">
        <div className="flex flex-col items-center justify-center text-center  max-w-[880px]  ">
          ...
          <div className="mt-6 flex gap-4">
            <Button
              text="Enroll now"
              className="bg-[#FF6666]  text-[#FFFFFF]  "
            />
            <Button
              text="Book a visit"
              className="bg-[#FFECEC] text-[#3A3A3A]  "
            />
          </div>
        </div>
